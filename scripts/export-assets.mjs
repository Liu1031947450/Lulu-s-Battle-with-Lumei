...
try {
  ...
  const generated = await page.evaluate(() => {
    ...
    for (const kind of ['lulu', 'lumei']) {
      ...
      const atlas = { image: `${kind}.png`, size: [canvas.width, canvas.height], source: '../../src/art.js', animations: {} };
      ...
      Artwork.drawFighter(portrait.getContext('2d'), { id: 0, kind, x: 250, y: 574, facing: 1, state: 'idle', stateFrame: 0 }, 1, { scale: 1.78, shadow: false });
